...
def main():
    ...
    validation_results["OPENAI_API_KEY"] = validate_and_log("OpenAI", keys["OPENAI_API_KEY"], validate_openai)
    validation_results["GEMINI_API_KEY"] = validate_and_log("Gemini", keys["GEMINI_API_KEY"], validate_gemini)
    validation_results["GROQ_API_KEY"] = validate_and_log("Groq", keys["GROQ_API_KEY"], validate_groq)
    validation_results["HUGGINGFACE_API_KEY"] = validate_and_log("Hugging Face", keys["HUGGINGFACE_API_KEY"], validate_huggingface)
