...
class ShiftPrioritiesRunner:
    ...
    def __init__(self, test_pdf_path: str = None):
        ...
        self.results = {"timestamp": datetime.now().isoformat(), "shift_priorities": []}
    ...
    def priority_3_gpu_monitoring(self, duration: int = 30):
        ...
        try:
            ...
            report = monitor.monitor_workload(
                duration_seconds=duration, interval_seconds=2
            )
            monitor.save_log()
    ...
    def priority_6_rt_detr_unittest(self):
        ...
        try:
            ...
            return {
                ...
                "status": "completed",
                "success": exit_code == 0,
                "details": {"exit_code": exit_code, "test_passed": exit_code == 0},
            }
    ...
    def generate_shift_report(self):
        ...
        completed = sum(
            1
            for p in self.results["shift_priorities"]
        ...
        # Save to file
        report_file = Path(
            f"shift_priorities_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
...
def main():
    ...
    success_count = sum(
        1
        for p in results["shift_priorities"]
