...
class TestRTDetrV2Pipeline(unittest.TestCase):
    ...
    def test_01_cuda_available(self):
        ...
        self.assertTrue(
            cuda_available, "CUDA should be available for GPU-accelerated inference"
        )
    ...
    def test_02_model_loading(self):
        ...
        try:
            ...
            result = {"test": "model_loading", "passed": False, "error": str(e)}
            self.test_results["tests"].append(result)
    ...
    def test_03_inference(self):
        ...
        try:
            ...
            result = {"test": "inference", "passed": False, "error": str(e)}
            self.test_results["tests"].append(result)
    ...
    def test_04_performance_benchmark(self):
        ...
        try:
            ...
            print(
                f"  📊 Min/Max: {min(inference_times):.3f}s / {max(inference_times):.3f}s"
            )
            print(f"  🎯 Threshold: {threshold}s")

            if not passes_threshold:
                print("  ⚠️ WARNING: Performance below threshold")

        except Exception as e:
            result = {"test": "performance_benchmark", "passed": False, "error": str(e)}
            self.test_results["tests"].append(result)
    ...
    def test_05_memory_usage(self):
        ...
        try:
            ...
            result = {"test": "memory_usage", "passed": False, "error": str(e)}
            self.test_results["tests"].append(result)
    ...
    def tearDownClass(cls):
        ...
        results_file = Path(
            f"rt_detr_test_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
